...
$reader = New DbReader("localhost", "root", "database", "DOCUMENTS");
...
$detective = new DbFileReader("localhost", "root", "database");
...
$reader = new DbFileReader("localhost", "root", "database");
